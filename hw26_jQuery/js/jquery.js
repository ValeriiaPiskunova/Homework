...
!(function (e, t) {
    ...
    function re(e, t, n, r) {
      ...
      if (((n = n || []), 1 === c.length)) {
        if (
          ...
          if (
            !(t = (b.find.ID(a.matches[0].replace(O, P), t) || [])[0])
          )
            return n;
          l && (t = t.parentNode),
        ...
        var n = arguments.length,
          ...
          a = function (t) {
            return function (e) {
              (r[t] = this),
                (i[t] =
                  1 < arguments.length ? ae.call(arguments) : e),
                --n || o.resolveWith(r, i);
            };
          };
        if (
  ...
  (ce.Animation = ce.extend(yt, {
    ...
    (ct = C.createElement("select").appendChild(
  ...
  ce.fn.extend({
    ...
    (mt = {
      set: function (e, t, n) {
        return (
          !1 === t ? ce.removeAttr(e, n) : e.setAttribute(n, n), n
        );
      },
    }),
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          ...
          ((e = e[ce.expando]
            ? e
            : new ce.Event(d, "object" == typeof e && e)).isTrigger =
            r ? 2 : 3),
          (e.namespace = h.join(".")),
    ...
    ce.extend({
      ...
      ajax: function (e, t) {
        ...
        var c,
          ...
          y = v.context || v,
          m =
            v.context && (y.nodeType || y.jquery) ? ce(y) : ce.event,
          x = ce.Deferred(),
  ...
  ce.ajaxSetup({
    ...
    (le.createHTMLDocument =
      (((Jt =
        C.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
